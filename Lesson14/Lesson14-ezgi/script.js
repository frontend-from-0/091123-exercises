...
let number8 = 8;
let number9=number8++;
console.log('Exercise 10:' , number8 , number9 );
console.log('------------------------');
...
let number10 = -3;
number10++;
const result3 = number10*2;
console.log('Exercise 11:' , result3 );
console.log('------------------------');
...
++a;
const result4 = a+b;
console.log('Exercise 12:' , result4 );

console.log('------------------------');
// 13. Generate a random number in a range from 11 (including) to 35 (excluding).
let randomNumber2 = Math.floor(Math.random()*(35-11) + 11);
console.log('Exercise 14:' , randomNumber2);
console.log('------------------------');
