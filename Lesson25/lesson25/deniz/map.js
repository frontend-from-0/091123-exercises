...
console.log("--------------");
console.log("Egzersiz4:", wordsExercise4.map(word => word.length));
// Exercise 5:
...
console.log("--------------");
const newStudentsNameAndGrade = studentsExercise5.map(student => `${student.name} ${student.grade}`);
console.log(newStudentsNameAndGrade);
...
const nunberToString = numbersExercise6.map(number => number.toString());
console.log("Egzersiz 6:",nunberToString);
...
console.log("--------------");
console.log("Egzeriz 7: ",sentencesExercise7.map(sentence => sentence.split(' ')));
...
console.log("Egzersiz 8:" ,emailAddresses);
// Exercise 9:
...
console.log("Egzersiz 9:" ,bookTitlesAndAuthors);
...
const pricesWithSymbol = pricesExercise10.map(price => `${price}${currencySymbol}`);
console.log("egzersiz 10:" ,pricesWithSymbol);
