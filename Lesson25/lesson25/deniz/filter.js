...
console.log("-----------------------")
console.log("egzersiz 3: ", booksExercise9.filter(book => book.price < 10));
...
console.log("-----------------------")
console.log("egzersiz 4; ", usersExercise4.filter(user => user.age < 25));
...
console.log("Egzersiz 5: ", filteredSentences);
...
console.log("egzersiz 6; ", outOfStockProducts);
...
console.log("Egzersiz 7: ", divisibleNumbers);
...
console.log("-----------------------")
console.log("Egzersiz 8;", wordsExercise8.filter(
	character => character.length < 5
));
...
console.log("egzersiz 9:", filteredStudents);
...
console.log("Egzersiz 10:", usersExercise10.filter(
