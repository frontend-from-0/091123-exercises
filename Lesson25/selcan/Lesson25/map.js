...
console.log("exercise5:",wordsExercise4.map(item =>item.length));
...
console.log("Exercise5;",studentsExercise5.map(student =>`${student.name} ${student.grade}`));
...
console.log("Exercise6:",numbersExercise6.map(number=>number.toString()));
...
console.log("Exercise7:",sentencesExercise7.map(number=>number.split(" ")));
...
console.log("Exercise8:",usersExercise8.map(user=>user.email));
...
console.log("Exercise9:",booksExercise9.map(items=>`${items.title},${items.author}`));
...
console.log("Exercise10:",pricesExercise10.map(item=>`${item}$`));
