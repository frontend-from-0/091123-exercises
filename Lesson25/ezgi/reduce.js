...
console.log( numbersEx2.reduce((max, currentValue) => {
...
const elementCounts = elements.reduce((accumulator, currentValue) => {
  ...
  if (accumulator[currentValue]) {
    ...
    console.log("accu2");
    console.log(accumulator);
    console.log("current 2: " + currentValue);
...
const sumOfNunmbers =  numbersEx4.reduce( (accumulator,currentValue) => accumulator + currentValue);
const averageOfNunmbers= sumOfNunmbers/ numbersEx4.length;


console.log(averageOfNunmbers);
...
const uniqueElements= numbers.reduce((accumulator, currentValue) => {
