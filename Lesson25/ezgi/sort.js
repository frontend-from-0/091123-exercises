...
const sortDescendingOrder= [...scores].sort((a, b)=> b - a);
...
const sortAscendingOrder = [...people].sort((a,b) => a.age - b.age);
...
const sortStringsByLength = [...words].sort((a, b) => a.length - b.length);
console.log(sortStringsByLength);
