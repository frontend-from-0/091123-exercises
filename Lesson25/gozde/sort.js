...
const sortedDescendingNumbers = [...scores].sort((a, b)=> b - a);
...
const sortedAscendingOrder = [...people].sort((a,b) => a.age - b.age);
...
const sortedStringsByLength = [...words].sort((a, b) => a.length - b.length);
console.log(sortedStringsByLength);
