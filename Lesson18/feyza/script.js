...
function concateSpace (arr) {
  return arr.join(" ");
}

console.log("Exercise 3:", concateSpace(stringE3));
...
const inputArray = [1, 2, 3, 4, 7, 10];
const outputArray = arrayOddNumbers(inputArray);

console.log("Ex4:", outputArray );
console.log('----------------------------');
...
const inputArray2 = [1, 2, 3, 4, 7, 10];
const outputArray2 = arrayEvenNumbers(inputArray2); 

console.log('Exercise 5: ', outputArray2);
console.log('----------------------------');
...
function removeValueFromArray(array, valueToRemove){
  ...
  for(let i = 0; i < array.length; i++) {
    ...
    if (array[i] !== valueToRemove){
      console.log('inside if statement', i, array[i], valueToRemove);
...
function keyExistEx9(object, key) {
  return object.hasOwnProperty(key);
}

keyExistEx9(testObjEx9, 'age');
keyExistEx9(testObjEx9, 'number');


console.log("Ex 9:",testObjEx9);
...
function keyValuePair(object, key, value){
  object[key] = value;
  return object;
}
console.log("Ex10 : ", testObjEx10)
console.log('----------------------------');
...
function removeKeyValuePair(object, keyToRemove) {
  delete object[keyToRemove];
  return object;
}
const modifiedObject = removeKeyValuePair(inputObject, "city");

console.log("Ex11 :", modifiedObject);
...
const resultObject = arraysToObject(array1Ex12, array2Ex12);
