...
function connectVariables(words) {
  return words.join(" ");
}

console.log("Exercise 3:", connectVariables(stringE3));
console.log('----------------------------');
...
console.log("Ex4", findOddNumbers(arrayEx) );
console.log('----------------------------');
...
console.log('Exercise 5: ', findEvenNumbers(testArrayEx5));
console.log('----------------------------');
...
function findKeyInObject(object,key){
  console.log("Ex 9:", object.hasOwnProperty(key));
}
findKeyInObject(testObjEx9, 'age');
findKeyInObject(testObjEx9, 'surname');
...
console.log("Ex 10:",addNewKey(testObjEx10,"city","New York"));
console.log('----------------------------');
...
console.log("Ex 11:",removeKey(testObjEx11,"city"));
console.log('----------------------------');
...
// function mergeKeyAndValue(arrayOfKey,arrayOfValue){
// for(i=0 ; i<arrayOfKey.length ; i++){
//   for(j=0; j<arrayOfValue.length; j++){
// newArray[arrayOfKey[i]]=arrayOfValue[j];
//   }
// }
// return newArray;
// }
function mergeKeyAndValue(arrayOfKey,arrayOfValue){
   for(i=0 ; i<arrayOfKey.length ; i++){
    newArray[arrayOfKey[i]]=arrayOfValue[i];
   } 
   return newArray;
  }
console.log("Ex 12:",mergeKeyAndValue(array1Ex12,array2Ex12));
