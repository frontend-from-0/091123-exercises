...
const endIndex = startIndex + 'Databases'.length;
console.log('Ex. 14: ', stringExercise14.substring(startIndex, endIndex));
console.log('------------------------');
...
const startIndexEx16 = planPriceString.indexOf('-') + 2; // Assuming that the - always separates the title and price 
const endIndexEx16 = planPriceString.indexOf('/'); // Assuming that the - always separates the price and interval 
console.log('Ex. 16:', planPriceString.slice(startIndexEx16, endIndexEx16));
console.log('------------------------');
